...
pathPre = "D:\\eventVision\\collecting\\11_19"  # pre set event camera.

args.output_path = "D:\\eventVision\\collecting\\11_19\\1.aedat4"
  ...
  #  mean_value = np.mean(event_values)
   ...
   # max_value = np.max(event_values)
    if timestamps.size > 0:
        ...
        # 保存统计信息到 txt 文件（追加写入）
        with open("D:\\eventVision\\collecting\\11_19\\1\\UAV_event_statistics.txt", "a") as f:
    ...
    cv.imwrite("D:\\eventVision\\collecting\\11_19\\1\\UAV_"+str(i)+".png",frame)
    i = i + 1
