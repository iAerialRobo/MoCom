...
def segment_actions(pos_ratio, variance, total_events, min_action_length=10):
    ...
    variance_threshold = np.median(variance) * 0.9  # 示例值，动态调整
...
# file_path = 'D:\\eventVision\\collecting\\11_17\\1_process\\filtered\\event_stats.txt'
...
# file_path = 'D:\\eventVision\\collecting\\4_23\\result3\\filtered\\event_stats.txt'
# GT 结果（去掉第一个 1）
...
plt.legend()
plt.grid(True)
plt.savefig('final_action_segments1.png')
plt.show()
