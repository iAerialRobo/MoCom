...
if __name__ == '__main__':
    ...
    parser.add_argument('-out-dir', type=str, default='/home/zhangnb/Tro/source/log', help='root dir for saving logs and checkpoint')
    ...
    # Define the datasets and corresponding output files
    datasets = [
    ...
    output_files = [
        '/home/zhangnb/Tro/source/log/cnn_output_small_frame.txt',
        '/home/zhangnb/Tro/source/log/cnn_output_frame.txt',
        '/home/zhangnb/Tro/source/log/cnn_output_remote_frame.txt'
    ]
