...
class NPZDataset(DatasetFolder):
    ...
    def __getitem__(self, index):
        ...
        #frames =  frames[:4, : ,:,:]
	# 下采样
        indices = torch.linspace(0, frames.shape[0] - 1, steps=8).long()  # [0, 5, 10, 15]
...
def main():
  ...
  #   ops, params = get_model_complexity_info(net, ())
   ...
   #  args.data_dir = '/media/mav_ficker/129e41ac-2a58-4c8c-8014-3432c588108c/data/data_frame/'
    ...
    args.out_dir = '/home/zhangnb/Tro/source/UAV_inference'
    optimizer = None
    if args.opt == 'sgd':
